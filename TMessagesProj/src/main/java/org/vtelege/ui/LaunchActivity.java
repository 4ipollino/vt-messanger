...
import org.vtelege.messenger.NativeCrashManager;
...
import org.vtelege.ui.Adapters.DrawerLayoutAdapter;
import org.vtelege.ui.ActionBar.ActionBarLayout;
import org.vtelege.ui.ActionBar.BaseFragment;
import org.vtelege.ui.ActionBar.DrawerLayoutContainer;
import org.vtelege.ui.Components.EmbedBottomSheet;
import org.vtelege.ui.Components.JoinGroupAlert;
import org.vtelege.ui.Components.LayoutHelper;
import org.vtelege.ui.Components.PasscodeView;
...
import org.vtelege.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("vtelege.me") || host.equals("t.me") || host.equals("vtelege.dog")) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://vtelege.org").replace("tg://resolve", "tg://vtelege.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:join", "tg://vtelege.org").replace("tg://join", "tg://vtelege.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://vtelege.org").replace("tg://addstickers", "tg://vtelege.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://vtelege.org").replace("tg://msg", "tg://vtelege.org").replace("tg://share", "tg://vtelege.org").replace("tg:share", "tg://vtelege.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                    ...
                    } else if (intent.getAction().equals("org.vtelege.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
