...
package org.vtelege.messenger.voip;
...
import org.vtelege.messenger.StatsController;
...
import org.vtelege.ui.VoIPActivity;
import org.vtelege.ui.VoIPFeedbackActivity;
import org.vtelege.ui.VoIPPermissionActivity;
...
public class VoIPService extends Service implements VoIPController.ConnectionStateListener, SensorEventListener, AudioManager.OnAudioFocusChangeListener, NotificationCenter.NotificationCenterDelegate{
	...
	public void onCreate() {
		...
		try {
			...
			cpuWakelock = ((PowerManager) getSystemService(POWER_SERVICE)).newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "vtelege-voip");
			cpuWakelock.acquire();
	...
	private void configureDeviceForCall() {
		...
		try{
			if(proximity!=null){
				proximityWakelock=((PowerManager) getSystemService(Context.POWER_SERVICE)).newWakeLock(PROXIMITY_SCREEN_OFF_WAKE_LOCK, "vtelege-voip-prx");
