 ...
 */
package org.vtelege.messenger.exoplayer2;
...
import org.vtelege.messenger.exoplayer2.audio.AudioCapabilities;
import org.vtelege.messenger.exoplayer2.audio.AudioRendererEventListener;
import org.vtelege.messenger.exoplayer2.audio.AudioTrack;
import org.vtelege.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
import org.vtelege.messenger.exoplayer2.decoder.DecoderCounters;
import org.vtelege.messenger.exoplayer2.drm.DrmSessionManager;
import org.vtelege.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import org.vtelege.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import org.vtelege.messenger.exoplayer2.metadata.Metadata;
import org.vtelege.messenger.exoplayer2.metadata.MetadataRenderer;
import org.vtelege.messenger.exoplayer2.metadata.id3.Id3Decoder;
import org.vtelege.messenger.exoplayer2.source.MediaSource;
import org.vtelege.messenger.exoplayer2.source.TrackGroupArray;
import org.vtelege.messenger.exoplayer2.text.Cue;
import org.vtelege.messenger.exoplayer2.text.TextRenderer;
import org.vtelege.messenger.exoplayer2.trackselection.TrackSelectionArray;
import org.vtelege.messenger.exoplayer2.trackselection.TrackSelector;
import org.vtelege.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import org.vtelege.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class SimpleExoPlayer implements ExoPlayer {
  ...
  protected void buildVideoRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("org.vtelege.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("org.vtelege.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("org.vtelege.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
    ...
    try {
      Class<?> clazz =
          Class.forName("org.vtelege.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
